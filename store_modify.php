...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			<div class="section no-pad-bot" id="index-banner">
				<h3 class="header center">Modify Table - Store</h3>
			</div>
	...
	<?php
		...
		//update 
		$sql = 'INSERT INTO store VALUES ('.$storeid.', "'.$storename.'", "'.$storelocation.'");';
		$result = $conn->query($sql);
		...
		//update
		$sql = 'UPDATE store SET StoreID='.$storeid.', StoreName="'.$storename.'", StoreLocation="'.$storelocation.'" WHERE StoreID='.$storeid.';';
		$result = $conn->query($sql);
 ...
 <!-- forms, update add, remove, update -->
  <div class="row">
	...
	<br>
		...
		<a class="waves-effect waves-light btn-large modal-trigger" href="store.php"><i class="material-icons left">arrow_left</i>BACK</a>
		<br>
		<br>
		<br>
		<br>
