...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			<div class="section no-pad-bot" id="index-banner">
				<h3 class="header center">Modify Table - CustPhoneNum</h3>
			</div>
	...
	<?php
		...
		//update
		$sql = 'DELETE FROM custphonenum WHERE CustomerPhoneNumber='.$phonenum.';';
		$result = $conn->query($sql);
	
		mysqli_close($conn);
	
		//update link to table page
		echo "<script>window.location = 'custphonenum.php'</script>";
		}
		...
		//update 
		$sql = 'INSERT INTO custphonenum VALUES ("'.$phonenum.'", '.$custid.');';
		$result = $conn->query($sql);
		...
		//update
		$custid=$_POST['custid']; 
		$phonenumold=$_POST['phonenumold'];
		$phonenumnew=$_POST['phonenumnew'];
		...
		//update
		$sql = 'UPDATE custphonenum SET CustID='.$custid.', CustomerPhoneNumber="'.$phonenumnew.'" WHERE CustomerPhoneNumber='.$phonenumold.';';
		$result = $conn->query($sql);
 ...
 <!-- forms, update add, remove, update -->
  <div class="row">
	...
	<br>
		<form method="post"> 
		<p>Customer Phone-Number to remove:</p>
	...
	<br>
		<form method="post">
		<p>Old Customer Phone Number:</p>
		<input type="text" name="phonenumold"/> 
		<p>New Customer Phone Number:</p>
		<input type="text" name="phonenumnew"/> 
		<p>Customer ID:</p>
		<input type="text" name="custid"/> 
	...
	<br>
		...
		<a class="waves-effect waves-light btn-large modal-trigger" href="custphonenum.php"><i class="material-icons left">arrow_left</i>BACK</a>
		<br>
		<br>
		<br>
		<br>
